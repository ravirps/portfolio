    ...
    <HydrationSafe fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}>
      <div className="py-4 sm:py-8">
        <div className="max-w-4xl mx-auto px-3 sm:px-6">
          ...
          {/* Temporary Clear Auth Button - Remove this after testing */}
          {isHydrated && (
            <div className="flex justify-end mb-2">
              <button
                onClick={() => {
                  localStorage.removeItem("biodataAuthenticated");
            ...
            <div className="flex-1 text-center w-full">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="bg-purple-50 p-3 sm:p-4 rounded-lg hover:bg-purple-100 transition-colors">
                  ...
                  <p className="font-semibold text-gray-800 text-sm sm:text-base">Unmarried</p>
                </div>
              </div>
            </div>
          </div>
