      ...
      <div className="flex items-center justify-between py-5">
        <div className="flex flex-shrink-0 items-center">
          <Link
            ...
            <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-[#16f2b3] shadow-lg">
              <Image
            ...
            <span className="text-[#16f2b3] text-xl font-bold">RAVI PRATAP SINGH</span>
          </Link>
        </div>
        ...
        <ul className="mt-4 flex h-screen max-h-0 w-full flex-col items-start text-sm opacity-0 md:mt-0 md:h-auto md:max-h-screen md:w-auto md:flex-row md:space-x-1 md:border-0 md:opacity-100" id="navbar-default">
          ...
          <li>
            <Link className="block px-4 py-2 no-underline outline-none hover:no-underline" href="/biodata"><div className="text-sm text-white transition-colors duration-300 hover:text-pink-600">BIODATA</div></Link>
          </li>
        </ul>
      </div>
    </nav>
